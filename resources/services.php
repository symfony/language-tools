...
return static function (ContainerConfigurator $container): void {
    ...
    $services->load('Symfony\\Lsp\\Check\\', '../src/Check/*{Manager,Registry,Parser,Selector,Runner,Reporter,Renderer,Profiler,Command,Client,Factory,Analyzer,Executor,Builder,Codec,Repository,Format}.php');
