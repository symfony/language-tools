...
Symfony API. Twig parameter mappings support explicit entries such as
...
diagnosed. Unpacking inside a parameter value doesn't make the parameter map
dynamic. A quick fix adds the missing parameters to the literal parameter map.
