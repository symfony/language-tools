...
analysis limit fail the project's source indexing rather than exposing partial
declarations. Split a large configuration into smaller imported files to keep
