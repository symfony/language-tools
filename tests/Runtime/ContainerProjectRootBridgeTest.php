    ...
    public function testRunsTheBridgeThroughAMappedProjectRoot(): void
    {
        ...
        $initializer = new ProjectRuntimeInitializer(
            ...
            new RuntimeSnapshotLoaderRegistry([
                new ProjectTemplateSnapshotLoader($templateIndexes, new UriToPathConverter()),
                new ProjectAssetSnapshotLoader($assetIndexes),
                new ProjectStimulusSnapshotLoader($stimulusIndexes, new StimulusControllerSourceLoader(new JavaScriptTokenizer(), new StimulusControllerSourceAnalyzer(new PositionConverter()))),
            ], $pathMapper),
            $configuration,
            $pathMapper,
